...
compute_scores_from_rna_scoring "TestSetI";
compute_scores_from_rna_scoring "TestSetII";
compute_scores_from_rna_scoring "TestSetIII";
compute_scores_from_rna_scoring "TestSetI_tmp";
